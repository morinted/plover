...
class StenographTestCase(unittest.TestCase):
    def test_sequence_number(self):
        ...
        # Reset to 0
        USBPacket.sequence_number = 0
        sequence_number = USBPacket.make_open_request().sequence_number
        assert sequence_number == 0
        assert USBPacket.sequence_number == 1
        USBPacket.sequence_number = 0xFFFFFFFD # second last sequence number
        sequence_number = USBPacket.make_read_request().sequence_number
    ...
    def test_usb_packet_from_data(self):
        ...
        raw_packet = bytearray(
            [0x53, 0x47,  # SG
             ...
             USBPacket.ACTION_READ, 0,  # Action (static)
