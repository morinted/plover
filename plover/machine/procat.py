...
class ProCAT(plover.machine.base.SerialStenotypeBase):
    """Standard stenotype interface for a ProCAT machine.
...
if __name__ == '__main__':
    print(ProCAT.process_steno_packet([0b01000000, 0, 0, 0xFF]))  # #
    print(ProCAT.process_steno_packet([0b00100000, 0, 0, 0xFF]))  # S-
    print(ProCAT.process_steno_packet([0x7F, 0xFF, 0xFF, 0xFF]))
